...
- [Quick start](#quick-start)
  - [Install as a package](#install-as-a-package)
    - [Ollama shell defaults](#ollama-shell-defaults)
    - [Multi-modal (optional)](#multi-modal-optional)
...
- [Use Cases](#use-cases)
    ...
    - [AI Data Techician](#ai-data-techician)
    ...
    - [Earth Online Memory Game](#earth-online-memory-game)
    - [Multi-Agent Orchestration Platform](#multi-agent-orchestration-platform)
    - [Your Personal Tasting Universe](#your-personal-tasting-universe)
    ...
    - [MCO - Orchestrate AI Coding Agents](#mco---orchestrate-ai-coding-agents)
    - [Study Buddy with Self-Evolving Memory](#study-buddy-with-self-evolving-memory)
    - [Alzheimer’s Memory Assistant](#alzheimers-memory-assistant)
    - [Memory-Driven Multi-Agent NPC Experience](#memory-driven-multi-agent-npc-experience)
    - [Mobi Companion](#mobi-companion)
    - [AI Wearable with Memory](#ai-wearable-with-memory)
    - [OpenClaw Agent Memory](#openclaw-agent-memory)
